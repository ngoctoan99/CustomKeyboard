...
import com.example.customkeyboard.lib.ui.main.ItemMainKeyboard.Companion.KEYCODE_MODE_CHANGE
import com.example.customkeyboard.lib.ui.main.ItemMainKeyboard.Companion.KEYCODE_SHIFT
import com.example.customkeyboard.lib.ui.main.ItemMainKeyboard.Companion.KEYCODE_SPACE
import com.example.customkeyboard.lib.ui.main.ItemMainKeyboard.Companion.MAX_KEYS_PER_MINI_ROW
...
class MainKeyboard @JvmOverloads constructor(
    ...
    init {
        ...
        mSpaceMoveThreshold = resources.getDimension(R.dimen.frogo_dimen_8dp).toInt()
    ...
    override fun onVisibilityChanged(changedView: View, visibility: Int) {
        ...
        if (visibility == VISIBLE) {
            ...
            // set background keyboard android
...
//                }
    ...
    private fun onBufferDraw() {
        ...
        //////////set background key of keyboard android
